package textClassificationNesaHyperlink;
...
public class GenerateDataPoints {
	public static void main(String args[]) throws IOException, ClassNotFoundException{
		...
		VSMHyperlink vsmHyperlink = new VSMHyperlink(esaObject.invertedIndex, esaObject.documents);
		vsmHyperlink.initWikiBody();
		...
		for (int folderIndex = 0; folderIndex<folderNames.length;folderIndex++){
			...
			for (File doc : fileNames){
				...
				documentVector = vsmHyperlink.getVector(wordArray);
